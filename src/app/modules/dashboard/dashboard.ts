...
import { MERCHANTS } from '../../data/static-data';
    ...
    <div class="h-full overflow-y-auto p-6 custom-scrollbar space-y-8">
      ...
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-3">
          <div class="bg-white dark:bg-[#1E293B] px-4 py-2 rounded-xl border border-slate-100 dark:border-white/5 shadow-sm flex items-center gap-2">
            ...
            <span class="text-sm font-bold text-[#1A1A1A] dark:text-white">March 08, 2024</span>
          </div>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="card flex items-center gap-6 group hover:border-[#FFC107]/30 transition-all">
          ...
          <div>
            <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Total Orders Today</p>
            <p class="text-3xl font-black text-[#1A1A1A] dark:text-white">1,284</p>
        ...
        <div class="card flex items-center gap-6 group hover:border-[#FFC107]/30 transition-all">
          ...
          <div>
            ...
            <p class="text-3xl font-black text-[#1A1A1A] dark:text-white">₹12,450.00</p>
            <div class="mt-2 w-32 h-1.5 bg-slate-100 dark:bg-white/5 rounded-full overflow-hidden">
        ...
        <div class="card flex items-center gap-6 group hover:border-[#FFC107]/30 transition-all">
          ...
          <div>
            ...
            <p class="text-3xl font-black text-[#1A1A1A] dark:text-white">86</p>
            <div class="mt-2 w-32 h-1.5 bg-slate-100 dark:bg-white/5 rounded-full overflow-hidden">
      ...
      <div class="space-y-4">
        <div class="flex items-center justify-between">
          ...
          <button class="text-sm font-bold text-[#FFC107] hover:underline">View All</button>
        </div>
            ...
            <div class="card !p-0 overflow-hidden group hover:shadow-xl transition-all border-none ring-1 ring-slate-100 dark:ring-white/5">
              ...
              <div class="p-4">
                ...
                <div class="mt-4 flex items-center justify-between">
                  <button [routerLink]="['/create-order']" class="text-xs font-bold bg-[#FFC107] text-black px-3 py-1.5 rounded-lg">Create Order</button>

              ...
              @for (order of filteredOrders(); track order.id) {
                <tr class="hover:bg-slate-50 dark:hover:bg-white/5 transition-colors">
                  <td class="px-6 py-4">
                    ...
                    <p class="text-[10px] text-slate-400 uppercase">{{ order.timestamp }}</p>
                  </td>
                  <td class="px-6 py-4">
                    <div class="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p class="text-[10px] text-slate-400">Bandra West, Mumbai</p>
                      </div>
                    </div>
                  </td>
                  <td class="px-6 py-4">
                    <div class="flex items-center gap-2 text-slate-600 dark:text-slate-400">
                      ...
                      <span class="text-sm font-medium">{{ order.merchant_name }}</span>
                    </div>
                  </td>
                  ...
                  <td class="px-6 py-4 text-center">
                    <button (click)="viewOrderDetails(order)" class="p-2 rounded-lg hover:bg-slate-200 dark:hover:bg-white/10 text-slate-400 transition-colors">
...
export class OrdersList {
  ...
  mockOrders = signal<MockOrder[]>([
    { id: '1', order_number: '#KL-8291', customer_name: 'Amit Patel', merchant_name: 'Grand Hyatt Hotel', grand_total: 6580, amount_received: 3000, balance_pending: 3580, status: 'preparing', timestamp: '2 mins ago' },
    { id: '2', order_number: '#KL-7123', customer_name: 'Suresh Raina', merchant_name: 'Marriott International', grand_total: 4200, amount_received: 4200, balance_pending: 0, status: 'delivered', timestamp: '15 mins ago' },
    { id: '3', order_number: '#KL-9012', customer_name: 'Priya Sharma', merchant_name: 'The Taj Mahal Palace', grand_total: 12500, amount_received: 5000, balance_pending: 7500, status: 'in-transit', timestamp: '1 hour ago' },
    { id: '4', order_number: '#KL-4456', customer_name: 'Rahul Dravid', merchant_name: 'Grand Hyatt Hotel', grand_total: 2100, amount_received: 0, balance_pending: 2100, status: 'cancelled', timestamp: '2 hours ago' },
  ]);
  ...
  getStatusClass(status: string): string {
    switch (status) {
      ...
      case 'in-transit': return 'bg-blue-100 text-blue-600 dark:bg-blue-500/10 dark:text-blue-400';
  ...
  viewOrderDetails(order: MockOrder) {
